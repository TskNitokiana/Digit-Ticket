 ...
 */
final class Version20201013072044 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event_type_event (event_id INT NOT NULL, type_event_id INT NOT NULL, INDEX IDX_6D4C547F71F7E88B (event_id), INDEX IDX_6D4C547FBC08CF77 (type_event_id), PRIMARY KEY(event_id, type_event_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event_type_event ADD CONSTRAINT FK_6D4C547FBC08CF77 FOREIGN KEY (type_event_id) REFERENCES type_event (id) ON DELETE CASCADE');
    }
