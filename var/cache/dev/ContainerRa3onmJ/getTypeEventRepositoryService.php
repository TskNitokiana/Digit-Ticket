...
// Returns the private 'App\Repository\TypeEventRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TypeEventRepository.php';

return $this->privates['App\Repository\TypeEventRepository'] = new \App\Repository\TypeEventRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
