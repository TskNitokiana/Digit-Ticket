...
// Returns the private 'App\Repository\UserTypeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UserTypeRepository.php';

return $this->privates['App\Repository\UserTypeRepository'] = new \App\Repository\UserTypeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
