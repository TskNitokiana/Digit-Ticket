...
// Returns the private 'App\Repository\TypePriceRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TypePriceRepository.php';

return $this->privates['App\Repository\TypePriceRepository'] = new \App\Repository\TypePriceRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
